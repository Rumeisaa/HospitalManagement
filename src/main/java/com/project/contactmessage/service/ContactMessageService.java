...
public class ContactMessageService {
    ...
    public ResponseMessage<ContactMessageResponse> save(ContactMessageRequest contactMessageRequest) {
        ...
        ContactMessage contactMessage = contactMessageMapper.requestToContactMessage(contactMessageRequest); // dto-Pojo donusumu yaptik
        ContactMessage savedData = contactMessageRepository.save(contactMessage); //saveData databaseden donen nesnemiz

        return ResponseMessage.<ContactMessageResponse>builder()
                .message(Messages.CONTACT_MESSAGE_CREATED_SUCCESSFULLY)
    ...
    public Page<ContactMessageResponse> getAll(int page, int size, String sort, String type) {
       ...
       Pageable pageable= PageRequest.of(page,size, Sort.by(sort).ascending()); //pageable nesnesi olusturduk
        ...
        return contactMessageRepository.findAll(pageable).map(contactMessageMapper::contactMessageToResponse);  //en sonunda  pojo nesneyi dto donusumu yaptik.
    ...
    public Page<ContactMessageResponse> searchByEmail(String email, int page, int size, String sort, String type) {
        ...
        return contactMessageRepository.findByEmailEquals(pageable,email).map(contactMessageMapper::contactMessageToResponse);

    }

    public Page<ContactMessageResponse> searchBySubject(String subject, int page, String sort, int size, String type) {
        ...
        return contactMessageRepository.findBySubjectEquals(pageable,subject).map(contactMessageMapper::contactMessageToResponse);
    }


    public String deleteById(Long contactMessageId) {
        //id kontrolu yapmam lazim
    ...
    public List<ContactMessage> searchBetweenTimes(String startHourString, String startMinuteString, String endHourString, String endMinuteString) {
        ...
        //String`i Integer`a donusum yapacagiz.
